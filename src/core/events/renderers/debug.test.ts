...
describe('DebugRenderer', () => {
  ...
  describe('Event Rendering', () => {
    it('should render breakpoint hit event', () => {
      const event: DebugBreakpointHitEvent = createDebugEvent('debug:breakpoint:hit', {
        breakpointId: 'bp-1',
        nodeName: 'testNode',
        hitCount: 1,
    ...
    it('should render step before event', () => {
      const event: DebugStepBeforeEvent = createDebugEvent('debug:step:before', {
        nodeName: 'testNode',
        stepType: 'step-over',
        variables: { a: 1, b: 2 },
      });
    ...
    it('should render variable inspect event', () => {
      const event: DebugVariableInspectEvent = createDebugEvent('debug:variable:inspect', {
        nodeName: 'testNode',
        variableName: 'myVar',
    ...
    it('should render execution pause event', () => {
      const event: DebugExecutionPauseEvent = createDebugEvent('debug:execution:pause', {
        nodeName: 'testNode',
        reason: 'breakpoint',
        variables: { x: 10 },
    ...
    it('should render execution resume event', () => {
      const event: DebugExecutionResumeEvent = createDebugEvent('debug:execution:resume', {
        nodeName: 'testNode',
        resumeMode: 'continue',
        duration: 5000,
      });
  ...
  describe('Command Handling', () => {
    it('should set command handler', () => {
      ...
      const handler = (renderer as unknown as { commandHandler: (cmd: string) => void }).commandHandler;
      handler('continue');
    ...
    it('should track paused state', () => {
      ...
      const resumeEvent: DebugExecutionResumeEvent = createDebugEvent('debug:execution:resume', {
        nodeName: 'testNode',
        resumeMode: 'continue',
        duration: 100,
      });
  ...
  describe('Edge Cases', () => {
    ...
    it('should format empty objects and arrays', () => {
      ...
      const event2: DebugVariableInspectEvent = createDebugEvent('debug:variable:inspect', {
        nodeName: 'test',
